...
jQuery(function($){
  ...
  $(document).ready(function(){
    ...
    footerHtml += '<a href="https://joomlead.com/documentation/" target="_blank">Documentation</a><span>|</span>';
    footerHtml += '<a href="https://joomlead.com/gantry-5-particles/" target="_blank">Gantry5 Particles</a><span>|</span>';
    footerHtml += '<a href="https://joomlead.com/joomla-template/" target="_blank">Premium Templates</a>';
    footerHtml += '</div>';
    footerHtml += '</div>';
