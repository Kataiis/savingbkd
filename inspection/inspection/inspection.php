<?php 
    ...
    if (isset($_REQUEST['delete_id'])) {
        ...
        unlink("upload/".$row['image']); // delete file
...
<body>
    ...
    <div class="container text-center">
        ...
        <a href="add.php" class="btn btn-success">Add New Job</a>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="edit.php?update_id=<?php echo $row['id']; ?>" class="btn btn-warning">Edit</a><BR><BR>                        
                            <a href="?delete_id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></td>                        
