        ...
        try {
            ...
            if (empty($name)) {
                ...
                if (!file_exists($path)) { // check file not exist in your upload folder path
                    if ($size < 5000000) { 
                        move_uploaded_file($temp, 'upload/'.$image_file); // move upload file temp directory to upload folder
                    } else {
            ...
            if (!isset($errorMsg)) {
                ...
                // if ($insert_stmt->execute()) {
                    ...
                    header('refresh:1;inspection.php');
                // }
            }
    ...
    <div class="container text-center">
        ...
        <div class="form-group">
            <div class="col-sm-12">
                ...
                <a href="inspection.php" class="btn btn-danger">Cancel</a>
            </div>
        </div>
        </form>
    </div>
